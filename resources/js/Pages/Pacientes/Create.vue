    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Novo Paciente</h2>
                ...
                <div class="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <p class="text-xs text-gray-500 mb-3">Defina uma senha para permitir que o paciente acesse o portal. Deixe em branco para não conceder acesso.</p>
                            <div class="max-w-sm">
                                <InputLabel for="senha" value="Senha do Portal" />
                        ...
                        <div class="flex items-center justify-end">
                            <PrimaryButton :disabled="form.processing">Salvar Paciente</PrimaryButton>
                        </div>
                    </form>
                </div>
            </div>
